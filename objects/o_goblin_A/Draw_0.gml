...
draw_sprite_ext(s_shadow, 0 , x, y+draw_hp_height, 2, 1.3, 0, c_white,0.3)
draw_self()
sc_drawcreature()
...
{ var color_ = make_colour_rgb(230, 230, 230)
	...
	if ds_list_find_value(symbollist,ds_list_find_index(symbollist,s_Defence))!=s_Defence
	{ds_list_add(symbollist,s_Defence)}
	}
	
if chargetimer < 0 and ds_list_find_value(symbollist,ds_list_find_index(symbollist,s_Defence))=s_Defence
{ds_list_delete(symbollist,ds_list_find_index(symbollist,s_Defence))}
