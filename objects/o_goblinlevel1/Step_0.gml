...
{timer=300 spawn1=1 with instance_create_layer(room_width,random_range(680-120,680),layer_,o_goblin_A) 
	{team=other.team leveluptolevel=1 levelgoto=other.level sc_levelup()}
	}

if timer<=0 and spawn1=1
{timer=300 spawn1=0 with instance_create_layer(room_width,random_range(680-120,680),layer_,o_goblin_A)
	{team=other.team leveluptolevel=1 levelgoto=other.level sc_levelup()}
	}
